...
export function AddClientModal({ open, onOpenChange, onSuccess }: AddClientModalProps) {
  ...
  const resetForm = () => {
    setNom(""); setCouleurMarque("#C4522A"); setCouleurSecondaire("#1A1A1A");
    setContactNom(""); setContactEmail(""); setContactTelephone("");
    setReseauxActifs([]); setNetworkData({});
    setFacturationAdresse(""); setFacturationMode("wave");
    setLogoUrl(null); setPendingLogoFile(null);
    setTab("identite");
  };
            ...
            <TabsContent value="identite" className="space-y-4 mt-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  <div
                    className="h-16 w-16 rounded-xl border-2 border-dashed border-border flex items-center justify-center shrink-0 overflow-hidden bg-muted"
